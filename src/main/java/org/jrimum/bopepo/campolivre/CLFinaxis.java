...
/**
 * <p>
 * O campo livre do Finaxis deve seguir esta forma:
 * </p>
 * 
 ...
 * @version 0.2
 */
class CLFinaxis extends AbstractCLFinaxis {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4730680396650341686L;
	...
	protected void addFields(Titulo titulo) {
		...
		this.add(new FixedField<String>(titulo.getNossoNumero().substring(1, 11), NOSSO_NUMERO_LENGTH, Fillers.ZERO_LEFT));
